        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <nav className="grid grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <Link href="/men" className="text-gray-600 hover:text-black transition-colors text-sm">
                      Men
                    </Link>
                  </li>
                  <li>
                    <Link href="/women" className="text-gray-600 hover:text-black transition-colors text-sm">
                      Women
                    </Link>
                  </li>
                  <li>
                    <Link href="/accessories" className="text-gray-600 hover:text-black transition-colors text-sm">
                      Accessories
                    </Link>
                  </li>
                  <li>
                    <Link href="/sale" className="text-gray-600 hover:text-black transition-colors text-sm">
                      Sale
                    </Link>
                  </li>
                </ul>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="text-center">
              <div className="text-8xl lg:text-9xl font-bold text-black leading-none">
                XIV
                <br />
                QR
              </div>
